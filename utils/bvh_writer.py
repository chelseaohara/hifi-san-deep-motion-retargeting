...
class BVHWriter():
    '''
    Copied from bvh_writer.py in Aberman codebase. build_joint_topology added to data manager
    '''
    def __init__(self, edges, names):
        self.parent, self.offset, self.names, self.edge2joint = DM.build_joint_topology(edges, names)
